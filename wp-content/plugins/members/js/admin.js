...
$j(document).ready(
        function () {
            ...
            $j('div.members-role-checkbox input[id="toggle_all"]').change(
                    function () {
                        if ($j(this).is(':checked')) {
                            $j('div.members-role-checkbox input[type="checkbox"]').prop('checked', true);
                        }
                        else {
                            $j('div.members-role-checkbox input[type="checkbox"]').prop('checked', false);
                        }
                    }
            );
