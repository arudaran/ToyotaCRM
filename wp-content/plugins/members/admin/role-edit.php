		...
		<form name="form0" method="post" action="<?php echo admin_url( esc_url( "users.php?page=roles&amp;action=edit&amp;role={$role->name}" ) ); ?>">
			...
			<table class="form-table">
				...
				<tr>
					...
					<td>
                                                <div class="members-role-checkbox clear">
                                                        <input  type="checkbox" name="<?php echo esc_attr( "role-caps[{$role->name}-toggle_all]" ); ?>" id="<?php echo esc_attr( "toggle_all" ); ?>" value="true" /> 
                                                        <label for="<?php echo esc_attr( "toggle_all" ); ?>"><?php echo "toggle_all"; ?></label>
                                                </div>                                            
