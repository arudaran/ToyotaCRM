...
function members_settings_page_create_meta_boxes() {
	...
	add_meta_box( 'members-role-manager', _x( 'Role Manager', 'meta box', 'members' ), 'members_meta_box_display_role_manager', $members->settings_page, 'advanced', 'high' );

	/* Add the 'Content Permissions' meta box. */
	add_meta_box( 'members-content-permissions', _x( 'Content Permissions', 'meta box', 'members' ), 'members_meta_box_display_content_permissions', $members->settings_page, 'advanced', 'high' );

	/* Add the 'Sidebar Widgets' meta box. */
	add_meta_box( 'members-widgets', _x( 'Sidebar Widgets', 'meta box', 'members' ), 'members_meta_box_display_widgets', $members->settings_page, 'advanced', 'high' );

	/* Add the 'Private Site' meta box. */
	add_meta_box( 'members-private-site', _x( 'Private Site', 'meta box', 'members' ), 'members_meta_box_display_private_site', $members->settings_page, 'advanced', 'high' );
}
