...
class WordPress_Crm_Load
{
    ...
    function activation()
    {
        ...
        $staff_role = add_role('department_staff', 'Department Staff', $staff_caps);

        $head_caps = array (
            'read_customers' => 'read_customers',
            'read_others_customers' => 'read_others_customers',
            'edit_customers' => 'edit_customers',
            'edit_others_customers' => 'edit_others_customers'
        );
        $head_role = add_role('head_of_department', 'Head of Department', $head_caps);
        ...
        $manager_role = add_role('management_board', 'Management Board', $manager_caps);
    }
    ...
    {
        remove_role('department_staff');
        remove_role('head_of_department');
        remove_role('management_board');
    }
}
